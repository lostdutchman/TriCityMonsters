...
screen main_menu():
    ...
    fixed:
        ...
        if main_menu:
           ...
           #textbutton _("Start") action Start()
           imagebutton auto "gui/mm_start_%s.png" xpos 0.625 ypos 472 focus_mask True action Start() hovered [Play ("sound", "audio/neonbuzz.ogg") ]
       ...
       #textbutton _("Preferences") action ShowMenu("preferences")
        ...
        if renpy.variant("pc"):
            ...
            ## Web.
            #textbutton _("Quit") action Quit(confirm=not main_menu)
            imagebutton auto "gui/mm_quit_%s.png" xpos 0.625 ypos 972 focus_mask True action Quit() hovered [Play ("sound", "audio/neonbuzz.ogg") ]
