...
label monster:
    "He pivots and leans in, kissing me the second he's been permitted. Honestly, I know he just said he wanted to make out back at Pitrats but it really feels like he was telling the truth in his actions now."
    "He's hungry but not desperate and the absolutely ludicrous amount of confidence he has is more hot than off putting.  I can't help but find it more engaging than actually arrogant."
    pov "... Hey.  Can you..."
    ...
    mori "If you're lucky, anyway.  Sure, but turn around for a second, the transformation isn't pretty.  Inbetween stages are... weird."
    ...
    "Immediately, I have to adjust where my eyes settle.  The figure in front of me now is significantly taller."
    "All the scant details I'd gathered from the confrontation in the alley sharpen into starker clarity."
    "He makes a half-hearted gesture with his thickly furred arms that has a very sarcastic {i}ta-da!{/i} feel and he averts his eyes in obvious embarrassment under the scrutiny."
    mori "One terminally overwarm demon form, as requested."
    "It's obvious he's trying to divert the gravity and awkwardness of the moment I'm still just absorbing it all."
    "His voice is much deeper like this, rough and growling even if he doesn't specifically mean to be threatening."
    ...
    "And I'm surprised when he starts at the contact.  But then the tension passes and he stays still..."
    "Though he does look away and even though his features are harder to read like this he definitely looks self conscious."
    ...
    "A soft, warm, seven foot tall cat who definitely ripped apart several demonic horrors with his bare hands not long ago."
    "The temptation to speak is strong, I want to make a quip and divert some of the awkwardness..."
    "But I have Mori trapped in a rare moment of serious vulnerability and I find myself wanting to explore it without smarmy comments."
    "At least for right now."
    "I reach for his hand- easily twice the size of mine, now- and examine the thick black claws there."
    "They're retracted, partially obscured by silvery fur but pressing on the mottled pads of his palm reveals the wickedly sharp curve."
    mori "..."
    "He's definitely nervous and it's incredibly uncharacteristic on him.  But I suppose that's fair.  I wonder how many people he's let this close before."
    ...
    "Honestly, I expect a quip or something but to my surprise he goes with it."
    "He braces one hand against the wall near my head and leans in, the slits of his eyes dilating in the lower light as we turn away from the street in what little privacy the shadows nearer the building afford."
...
label human:
    ...
    "Before I can protest, he grabs me by the hips and lifts me off the ground like I weigh {i}nothing{/i}, setting me down to sit on the low railing wall."
    "A half-thought occurs to me then- he must enjoy some of the benefits of being a demon even while in a human form-"
    "But of course he manages to distract me from fully considering what this might mean."
    "He leans his torso in between my knees with that smug little smirk, daring me to reprimand him, fingers tight and impatient where they still linger around my hipbones."
    "Of course I'm not going to just give him what he wants, though."
    "Okay maybe I will.  Just a little.  But only because I want it too."
    "I reach for his jaw and pull him in.  He goes willingly and our mouths meet with a degree of roughness that's exciting."
    "Mori doesn't hold anything back, ever, it seems.  And damn it is actually pretty exciting.  Now that I've touched him I can't really keep my hands off him."
    "Immediately, they're in his hair, finding a good grip to keep him in with."
    "Mori, of course, is already two steps ahead of me, pulling me into him so hard it's bordering on greedy.  It takes him a second to unstick one of his hands from my waist."
    "But then it's smoothing up my back and the hair on my neck and arms stands on end with the contact."
    "It feels good, very good, actually but a sudden thought occurs to me and I pull back with a bit of a jolt."
    pov "Can you reverse it?"
    mori "Buhh?"
    "I can't help the small laugh that makes its way past of my flushed lips."
    pov "You being a demon.  Have you tried to reverse it?"
    mori "There's not really a lot of demon authorities to talk to, you know?  Besides, I've spent most of the last three years avoiding them as much as possible."
   
    hide mori shirt neu
    show mori shirt hehe

    mori "Why, is the monster build not a bonus for you."
    pov "What am I supposed to do with a cat that big?"
    mori "We can always find out."
    pov "I like you just fine like this."
    mori "hehehh"
